...
const exactOverrides = {
  ...
  '《{value0}》已由私人书库发送至 Kindle。': '“{value0}” has been sent to Kindle by booknook.',
  ...
  '打开私人书库并设置新密码': 'Open booknook and set a new password',
  '重置私人书库密码': 'Reset your booknook password',
